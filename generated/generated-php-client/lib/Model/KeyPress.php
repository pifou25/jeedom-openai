 ...
 */
class KeyPress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'KeyPress';
    ...
    {
        $this->setIfExists('type', $data ?? [], 'keypress');
    ...
    */
     ...
     * Sets type
     *
     * @param string $type Specifies the event type. For a keypress action, this property is  always set to `keypress`.
     *
     * @return self
     */
