...
/**
 * FunctionToolCallOutput Class Doc Comment
 *
 * @category Class
 ...
 */
class FunctionToolCallOutput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FunctionToolCallOutput';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id The unique ID of the function tool call output. Populated when this item is returned via API.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string $type The type of the function tool call output. Always `function_call_output`.
     *
     * @return self
     */
