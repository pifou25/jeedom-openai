...
/**
 * ResponseFileSearchCallSearchingEvent Class Doc Comment
 *
 * @category Class
 ...
 */
class ResponseFileSearchCallSearchingEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseFileSearchCallSearchingEvent';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type The type of the event. Always `response.file_search_call.searching`.
     *
     * @return self
     */
     ...
     * Sets output_index
     *
     * @param int $output_index The index of the output item that the file search call is searching.
     *
     * @return self
     */
