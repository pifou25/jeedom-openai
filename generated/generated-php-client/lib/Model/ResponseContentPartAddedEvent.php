...
/**
 * ResponseContentPartAddedEvent Class Doc Comment
 *
 * @category Class
 ...
 */
class ResponseContentPartAddedEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseContentPartAddedEvent';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type The type of the event. Always `response.content_part.added`.
     *
     * @return self
     */
     ...
     * Sets item_id
     *
     * @param string $item_id The ID of the output item that the content part was added to.
     *
     * @return self
     */
     ...
     * Sets output_index
     *
     * @param int $output_index The index of the output item that the content part was added to.
     *
     * @return self
     */
     ...
     * Sets content_index
     *
     * @param int $content_index The index of the content part that was added.
     *
     * @return self
     */
