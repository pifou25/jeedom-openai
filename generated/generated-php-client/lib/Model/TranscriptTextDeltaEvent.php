...
/**
 * TranscriptTextDeltaEvent Class Doc Comment
 *
 * @category Class
 ...
 */
class TranscriptTextDeltaEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TranscriptTextDeltaEvent';
    ...
    */
     ...
     * Sets logprobs
     *
     * @param \JeedomOpenAI\Model\LogProbProperties[]|null $logprobs The log probabilities of the delta. Only included if you [create a transcription](/docs/api-reference/audio/create-transcription) with the `include[]` parameter set to `logprobs`.
     *
     * @return self
     */
