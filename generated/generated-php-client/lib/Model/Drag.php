 ...
 */
class Drag implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Drag';
    ...
    {
        $this->setIfExists('type', $data ?? [], 'drag');
    ...
    */
     ...
     * Sets type
     *
     * @param string $type Specifies the event type. For a drag action, this property is  always set to `drag`.
     *
     * @return self
     */
