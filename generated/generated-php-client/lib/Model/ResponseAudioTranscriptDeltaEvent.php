...
/**
 * ResponseAudioTranscriptDeltaEvent Class Doc Comment
 *
 * @category Class
 ...
 */
class ResponseAudioTranscriptDeltaEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseAudioTranscriptDeltaEvent';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type The type of the event. Always `response.audio.transcript.delta`.
     *
     * @return self
     */
     ...
     * Sets delta
     *
     * @param string $delta The partial transcript of the audio response.
     *
     * @return self
     */
