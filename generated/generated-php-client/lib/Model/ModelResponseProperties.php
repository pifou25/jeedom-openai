...
/**
 * ModelResponseProperties Class Doc Comment
 *
 * @category Class
 * @package  JeedomOpenAI
 * @author   OpenAPI Generator team
 ...
 */
class ModelResponseProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ModelResponseProperties';
    ...
    */
    ...
    public function setTemperature($temperature)
    {
        ...
        if (!is_null($temperature) && ($temperature > 2)) {
            throw new \InvalidArgumentException('invalid value for $temperature when calling ModelResponseProperties., must be smaller than or equal to 2.');
        }
        if (!is_null($temperature) && ($temperature < 0)) {
            throw new \InvalidArgumentException('invalid value for $temperature when calling ModelResponseProperties., must be bigger than or equal to 0.');
        }
    ...
    public function setTopP($top_p)
    {
        ...
        if (!is_null($top_p) && ($top_p > 1)) {
            throw new \InvalidArgumentException('invalid value for $top_p when calling ModelResponseProperties., must be smaller than or equal to 1.');
        }
        if (!is_null($top_p) && ($top_p < 0)) {
            throw new \InvalidArgumentException('invalid value for $top_p when calling ModelResponseProperties., must be bigger than or equal to 0.');
        }
