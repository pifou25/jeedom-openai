...
class MessageObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'thread_id' => 'string',
        'status' => 'string',
        'incomplete_details' => '\JeedomOpenAI\Model\MessageObjectIncompleteDetails',
        'completed_at' => 'int',
        'incomplete_at' => 'int',
        'role' => 'string',
        'content' => '\JeedomOpenAI\Model\MessageObjectContentInner[]',
        'assistant_id' => 'string',
        'run_id' => 'string',
        'attachments' => '\JeedomOpenAI\Model\CreateMessageRequestAttachmentsInner[]',
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['incomplete_at'] === null) {
     ...
     *
     * @return \JeedomOpenAI\Model\MessageObjectIncompleteDetails
     */
     ...
     *
     * @param \JeedomOpenAI\Model\MessageObjectIncompleteDetails $incomplete_details incomplete_details
     *
     * @return self
     */
     ...
     * Sets completed_at
     *
     * @param int $completed_at The Unix timestamp (in seconds) for when the message was completed.
     *
     * @return self
     */
     ...
     * Sets incomplete_at
     *
     * @param int $incomplete_at The Unix timestamp (in seconds) for when the message was marked as incomplete.
     *
     * @return self
     */
     ...
     * Gets content
     *
     * @return \JeedomOpenAI\Model\MessageObjectContentInner[]
     */
     ...
     * Sets content
     *
     * @param \JeedomOpenAI\Model\MessageObjectContentInner[] $content The content of the message in array of text and/or images.
     *
     * @return self
     */
     ...
     * Sets assistant_id
     *
     * @param string $assistant_id If applicable, the ID of the [assistant](/docs/api-reference/assistants) that authored this message.
     *
     * @return self
     */
     ...
     * Sets run_id
     *
     * @param string $run_id The ID of the [run](/docs/api-reference/runs) associated with the creation of this message. Value is `null` when messages are created manually using the create message or create thread endpoints.
     *
     * @return self
     */
     ...
     * Gets attachments
     *
     * @return \JeedomOpenAI\Model\CreateMessageRequestAttachmentsInner[]
     */
     ...
     * Sets attachments
     *
     * @param \JeedomOpenAI\Model\CreateMessageRequestAttachmentsInner[] $attachments A list of files attached to the message, and the tools they were added to.
     *
     * @return self
     */
