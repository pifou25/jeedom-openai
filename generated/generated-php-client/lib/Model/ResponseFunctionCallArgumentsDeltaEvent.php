...
/**
 * ResponseFunctionCallArgumentsDeltaEvent Class Doc Comment
 *
 * @category Class
 ...
 */
class ResponseFunctionCallArgumentsDeltaEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseFunctionCallArgumentsDeltaEvent';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type The type of the event. Always `response.function_call_arguments.delta`.
     *
     * @return self
     */
     ...
     * Sets item_id
     *
     * @param string $item_id The ID of the output item that the function-call arguments delta is added to.
     *
     * @return self
     */
     ...
     * Sets output_index
     *
     * @param int $output_index The index of the output item that the function-call arguments delta is added to.
     *
     * @return self
     */
     ...
     * Sets delta
     *
     * @param string $delta The function-call arguments delta that is added.
     *
     * @return self
     */
