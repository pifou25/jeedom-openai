...
/**
 * ResponseCodeInterpreterCallInProgressEvent Class Doc Comment
 *
 * @category Class
 ...
 */
class ResponseCodeInterpreterCallInProgressEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseCodeInterpreterCallInProgressEvent';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type The type of the event. Always `response.code_interpreter_call.in_progress`.
     *
     * @return self
     */
