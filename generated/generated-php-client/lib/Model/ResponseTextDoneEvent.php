...
/**
 * ResponseTextDoneEvent Class Doc Comment
 *
 * @category Class
 ...
 */
class ResponseTextDoneEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseTextDoneEvent';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type The type of the event. Always `response.output_text.done`.
     *
     * @return self
     */
     ...
     * Sets item_id
     *
     * @param string $item_id The ID of the output item that the text content is finalized.
     *
     * @return self
     */
     ...
     * Sets output_index
     *
     * @param int $output_index The index of the output item that the text content is finalized.
     *
     * @return self
     */
