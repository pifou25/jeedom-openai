...
class CreateBatchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const ENDPOINT_V1_RESPONSES = '/v1/responses';
    ...
    */
     ...
     * Sets endpoint
     *
     * @param string $endpoint The endpoint to be used for all requests in the batch. Currently `/v1/responses`, `/v1/chat/completions`, `/v1/embeddings`, and `/v1/completions` are supported. Note that `/v1/embeddings` batches are also restricted to a maximum of 50,000 embedding inputs across all requests in the batch.
     *
     * @return self
     */
