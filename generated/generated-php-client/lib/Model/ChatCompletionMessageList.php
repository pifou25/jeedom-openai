...
/**
 * ChatCompletionMessageList Class Doc Comment
 *
 * @category Class
 ...
 */
class ChatCompletionMessageList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ChatCompletionMessageList';
    ...
    protected static $openAPITypes = [
        'object' => 'string',
        'data' => '\JeedomOpenAI\Model\ChatCompletionMessageListDataInner[]',
        'first_id' => 'string',
        'last_id' => 'string',
        'has_more' => 'bool'
    ];
    ...
    */
     ...
     * Sets object
     *
     * @param string $object The type of this object. It is always set to \"list\".
     *
     * @return self
     */
     ...
     * Gets data
     *
     * @return \JeedomOpenAI\Model\ChatCompletionMessageListDataInner[]
     */
     ...
     * Sets data
     *
     * @param \JeedomOpenAI\Model\ChatCompletionMessageListDataInner[] $data An array of chat completion message objects.
     *
     * @return self
     */
     ...
     * Sets first_id
     *
     * @param string $first_id The identifier of the first chat message in the data array.
     *
     * @return self
     */
     ...
     * Sets last_id
     *
     * @param string $last_id The identifier of the last chat message in the data array.
     *
     * @return self
     */
     ...
     * Sets has_more
     *
     * @param bool $has_more Indicates whether there are more chat messages available.
     *
     * @return self
     */
