...
/**
 * ResponseFileSearchCallInProgressEvent Class Doc Comment
 *
 * @category Class
 ...
 */
class ResponseFileSearchCallInProgressEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseFileSearchCallInProgressEvent';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type The type of the event. Always `response.file_search_call.in_progress`.
     *
     * @return self
     */
     ...
     * Sets output_index
     *
     * @param int $output_index The index of the output item that the file search call is initiated.
     *
     * @return self
     */
     ...
     * Sets item_id
     *
     * @param string $item_id The ID of the output item that the file search call is initiated.
     *
     * @return self
     */
