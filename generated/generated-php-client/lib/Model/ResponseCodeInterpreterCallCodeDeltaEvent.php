...
/**
 * ResponseCodeInterpreterCallCodeDeltaEvent Class Doc Comment
 *
 * @category Class
 ...
 */
class ResponseCodeInterpreterCallCodeDeltaEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseCodeInterpreterCallCodeDeltaEvent';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type The type of the event. Always `response.code_interpreter_call.code.delta`.
     *
     * @return self
     */
     ...
     * Sets output_index
     *
     * @param int $output_index The index of the output item that the code interpreter call is in progress.
     *
     * @return self
     */
     ...
     * Sets delta
     *
     * @param string $delta The partial code snippet added by the code interpreter.
     *
     * @return self
     */
