...
/**
 * ChatCompletionList Class Doc Comment
 *
 * @category Class
 ...
 */
class ChatCompletionList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ChatCompletionList';
    ...
    protected static $openAPITypes = [
        'object' => 'string',
        'data' => '\JeedomOpenAI\Model\CreateChatCompletionResponse[]',
        'first_id' => 'string',
        'last_id' => 'string',
        'has_more' => 'bool'
    ];
    ...
    */
     ...
     * Sets data
     *
     * @param \JeedomOpenAI\Model\CreateChatCompletionResponse[] $data An array of chat completion objects.
     *
     * @return self
     */
     ...
     * Sets first_id
     *
     * @param string $first_id The identifier of the first chat completion in the data array.
     *
     * @return self
     */
     ...
     * Sets last_id
     *
     * @param string $last_id The identifier of the last chat completion in the data array.
     *
     * @return self
     */
     ...
     * Sets has_more
     *
     * @param bool $has_more Indicates whether there are more Chat Completions available.
     *
     * @return self
     */
