...
/**
 * InputContent Class Doc Comment
 *
 * @category Class
 * @package  JeedomOpenAI
 * @author   OpenAPI Generator team
 ...
 */
class InputContent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InputContent';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type The type of the input item. Always `input_text`.
     *
     * @return self
     */
     ...
     * Sets text
     *
     * @param string $text The text input to the model.
     *
     * @return self
     */
