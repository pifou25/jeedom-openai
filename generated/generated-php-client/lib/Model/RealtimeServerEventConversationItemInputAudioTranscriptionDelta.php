...
/**
 * RealtimeServerEventConversationItemInputAudioTranscriptionDelta Class Doc Comment
 *
 * @category Class
 ...
 */
class RealtimeServerEventConversationItemInputAudioTranscriptionDelta implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RealtimeServerEventConversationItemInputAudioTranscriptionDelta';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type The event type, must be `conversation.item.input_audio_transcription.delta`.
     *
     * @return self
     */
     ...
     * Sets content_index
     *
     * @param int|null $content_index The index of the content part in the item's content array.
     *
     * @return self
     */
