...
/**
 * FileSearchToolCall Class Doc Comment
 *
 * @category Class
 * @description The results of a file search tool call. See the  [file search guide](/docs/guides/tools-file-search) for more information.
 * @package  JeedomOpenAI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class FileSearchToolCall implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FileSearchToolCall';
    ...
    */
     ...
     * Sets id
     *
     * @param string $id The unique ID of the file search tool call.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string $type The type of the file search tool call. Always `file_search_call`.
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string $status The status of the file search tool call. One of `in_progress`,  `searching`, `incomplete` or `failed`,
     *
     * @return self
     */
