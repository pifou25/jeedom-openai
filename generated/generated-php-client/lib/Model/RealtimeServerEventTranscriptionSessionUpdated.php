...
/**
 * RealtimeServerEventTranscriptionSessionUpdated Class Doc Comment
 *
 * @category Class
 * @description Returned when a transcription session is updated with a &#x60;transcription_session.update&#x60; event, unless  there is an error.
 * @package  JeedomOpenAI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class RealtimeServerEventTranscriptionSessionUpdated implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RealtimeServerEventTranscriptionSessionUpdated';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type The event type, must be `transcription_session.updated`.
     *
     * @return self
     */
