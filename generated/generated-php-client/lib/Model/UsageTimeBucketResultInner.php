...
class UsageTimeBucketResultInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'usage_bytes' => 'int',
        'num_sessions' => 'int',
        'amount' => '\JeedomOpenAI\Model\CostsResultAmount',
        'line_item' => 'string'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('num_sessions', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['num_sessions'];
    }

    /**
     * Sets num_sessions
     *
     * @param int|null $num_sessions The number of code interpreter sessions.
     *
     * @return self
     */
    public function setNumSessions($num_sessions)
    {
        if (is_null($num_sessions)) {
            throw new \InvalidArgumentException('non-nullable num_sessions cannot be null');
        }
        $this->container['num_sessions'] = $num_sessions;
     ...
     * Gets amount
     *
     * @return \JeedomOpenAI\Model\CostsResultAmount|null
     */
     ...
     * Sets amount
     *
     * @param \JeedomOpenAI\Model\CostsResultAmount|null $amount amount
     *
     * @return self
     */
