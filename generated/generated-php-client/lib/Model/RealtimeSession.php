...
class RealtimeSession implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'input_audio_transcription' => '\JeedomOpenAI\Model\RealtimeSessionInputAudioTranscription',
        'turn_detection' => '\JeedomOpenAI\Model\RealtimeSessionTurnDetection',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('output_audio_format', $data ?? [], 'pcm16');
        ...
        $this->setIfExists('temperature', $data ?? [], 0.8);
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Unique identifier for the session that looks like `sess_1234567890abcdef`.
     *
     * @return self
     */
     ...
     *
     * @param string|null $output_audio_format The format of output audio. Options are `pcm16`, `g711_ulaw`, or `g711_alaw`. For `pcm16`, output audio is sampled at a rate of 24kHz.
     *
     * @return self
     */
     ...
     *
     * @return \JeedomOpenAI\Model\RealtimeSessionInputAudioTranscription|null
     */
     ...
     *
     * @param \JeedomOpenAI\Model\RealtimeSessionInputAudioTranscription|null $input_audio_transcription input_audio_transcription
     *
     * @return self
     */
     ...
     * Gets turn_detection
     *
     * @return \JeedomOpenAI\Model\RealtimeSessionTurnDetection|null
     */
     ...
     * Sets turn_detection
     *
     * @param \JeedomOpenAI\Model\RealtimeSessionTurnDetection|null $turn_detection turn_detection
     *
     * @return self
     */
     ...
     * Sets temperature
     *
     * @param float|null $temperature Sampling temperature for the model, limited to [0.6, 1.2]. For audio models a temperature of 0.8 is highly recommended for best performance.
     *
     * @return self
     */
