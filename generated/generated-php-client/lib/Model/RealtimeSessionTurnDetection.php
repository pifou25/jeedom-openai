...
class RealtimeSessionTurnDetection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param bool|null $create_response Whether or not to automatically generate a response when a VAD stop event occurs.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $interrupt_response Whether or not to automatically interrupt any ongoing response with output to the default conversation (i.e. `conversation` of `auto`) when a VAD start event occurs.
     *
     * @return self
     */
