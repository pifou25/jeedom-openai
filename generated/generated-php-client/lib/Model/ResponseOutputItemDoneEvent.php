...
/**
 * ResponseOutputItemDoneEvent Class Doc Comment
 *
 * @category Class
 ...
 */
class ResponseOutputItemDoneEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseOutputItemDoneEvent';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type The type of the event. Always `response.output_item.done`.
     *
     * @return self
     */
     ...
     * Sets output_index
     *
     * @param int $output_index The index of the output item that was marked done.
     *
     * @return self
     */
