...
/**
 * ResponseRefusalDoneEvent Class Doc Comment
 *
 * @category Class
 ...
 */
class ResponseRefusalDoneEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseRefusalDoneEvent';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type The type of the event. Always `response.refusal.done`.
     *
     * @return self
     */
     ...
     * Sets item_id
     *
     * @param string $item_id The ID of the output item that the refusal text is finalized.
     *
     * @return self
     */
     ...
     * Sets output_index
     *
     * @param int $output_index The index of the output item that the refusal text is finalized.
     *
     * @return self
     */
     ...
     * Sets content_index
     *
     * @param int $content_index The index of the content part that the refusal text is finalized.
     *
     * @return self
     */
