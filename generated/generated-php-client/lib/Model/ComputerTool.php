...
/**
 * ComputerTool Class Doc Comment
 *
 * @category Class
 * @description A tool that controls a virtual computer. Learn more about the  [computer tool](/docs/guides/tools-computer-use).
 * @package  JeedomOpenAI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ComputerTool implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ComputerTool';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type The type of the computer use tool. Always `computer_use_preview`.
     *
     * @return self
     */
