...
/**
 * FunctionToolCall Class Doc Comment
 *
 * @category Class
 * @description A tool call to run a function. See the  [function calling guide](/docs/guides/function-calling) for more information.
 * @package  JeedomOpenAI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class FunctionToolCall implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FunctionToolCall';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id The unique ID of the function tool call.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string $type The type of the function tool call. Always `function_call`.
     *
     * @return self
     */
