...
class AssistantObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'tool_resources' => '\JeedomOpenAI\Model\AssistantObjectToolResources',
    ...
    */
     ...
     * Sets name
     *
     * @param string $name The name of the assistant. The maximum length is 256 characters.
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string $description The description of the assistant. The maximum length is 512 characters.
     *
     * @return self
     */
     ...
     * Sets instructions
     *
     * @param string $instructions The system instructions that the assistant uses. The maximum length is 256,000 characters.
     *
     * @return self
     */
     ...
     * Sets tools
     *
     * @param \JeedomOpenAI\Model\AssistantObjectToolsInner[] $tools A list of tool enabled on the assistant. There can be a maximum of 128 tools per assistant. Tools can be of types `code_interpreter`, `file_search`, or `function`.
     *
     * @return self
     */
     ...
     * Gets tool_resources
     *
     * @return \JeedomOpenAI\Model\AssistantObjectToolResources|null
     */
     ...
     * Sets tool_resources
     *
     * @param \JeedomOpenAI\Model\AssistantObjectToolResources|null $tool_resources tool_resources
     *
     * @return self
     */
