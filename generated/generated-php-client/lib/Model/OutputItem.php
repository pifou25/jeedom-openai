 ...
 */
class OutputItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OutputItem';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type The type of the output message. Always `message`.
     *
     * @return self
     */
     ...
     * Sets call_id
     *
     * @param string $call_id An identifier used when responding to the tool call with output.
     *
     * @return self
     */
