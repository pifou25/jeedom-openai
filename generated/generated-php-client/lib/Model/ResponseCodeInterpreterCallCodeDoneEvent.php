...
/**
 * ResponseCodeInterpreterCallCodeDoneEvent Class Doc Comment
 *
 * @category Class
 ...
 */
class ResponseCodeInterpreterCallCodeDoneEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseCodeInterpreterCallCodeDoneEvent';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type The type of the event. Always `response.code_interpreter_call.code.done`.
     *
     * @return self
     */
     ...
     * Sets code
     *
     * @param string $code The final code snippet output by the code interpreter.
     *
     * @return self
     */
