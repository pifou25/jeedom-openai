...
/**
 * ResponseContentPartDoneEvent Class Doc Comment
 *
 * @category Class
 ...
 */
class ResponseContentPartDoneEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseContentPartDoneEvent';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type The type of the event. Always `response.content_part.done`.
     *
     * @return self
     */
     ...
     * Sets content_index
     *
     * @param int $content_index The index of the content part that is done.
     *
     * @return self
     */
