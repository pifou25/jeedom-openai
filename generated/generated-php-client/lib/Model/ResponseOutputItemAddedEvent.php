...
/**
 * ResponseOutputItemAddedEvent Class Doc Comment
 *
 * @category Class
 ...
 */
class ResponseOutputItemAddedEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseOutputItemAddedEvent';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type The type of the event. Always `response.output_item.added`.
     *
     * @return self
     */
     ...
     * Sets output_index
     *
     * @param int $output_index The index of the output item that was added.
     *
     * @return self
     */
