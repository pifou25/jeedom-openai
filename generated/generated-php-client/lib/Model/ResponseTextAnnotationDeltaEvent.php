...
/**
 * ResponseTextAnnotationDeltaEvent Class Doc Comment
 *
 * @category Class
 ...
 */
class ResponseTextAnnotationDeltaEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseTextAnnotationDeltaEvent';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type The type of the event. Always `response.output_text.annotation.added`.
     *
     * @return self
     */
     ...
     * Sets item_id
     *
     * @param string $item_id The ID of the output item that the text annotation was added to.
     *
     * @return self
     */
     ...
     * Sets output_index
     *
     * @param int $output_index The index of the output item that the text annotation was added to.
     *
     * @return self
     */
     ...
     * Sets content_index
     *
     * @param int $content_index The index of the content part that the text annotation was added to.
     *
     * @return self
     */
