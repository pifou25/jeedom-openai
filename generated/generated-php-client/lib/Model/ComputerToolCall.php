...
/**
 * ComputerToolCall Class Doc Comment
 *
 * @category Class
 * @description A tool call to a computer use tool. See the  [computer use guide](/docs/guides/tools-computer-use) for more information.
 * @package  JeedomOpenAI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ComputerToolCall implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ComputerToolCall';
    ...
    {
        $this->setIfExists('type', $data ?? [], 'computer_call');
    ...
    */
     ...
     * Sets type
     *
     * @param string $type The type of the computer call. Always `computer_call`.
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string $id The unique ID of the computer call.
     *
     * @return self
     */
